...
public class PokeBounceMainMenu extends FXGLMenu {
    ...
    protected Node createBackground(double width, double height) {
        return new ImageView(FXGL.image("MainMenu.gif"));
    }
    ...
    protected void showScores() throws FileNotFoundException {
        ...
        for (Map.Entry<String, Integer> entry : reverseSorted.entrySet()) {
            ...
            FileInputStream fileInput = new FileInputStream("src/assets/textures/HighScore50Pix.gif"); //FOR STATION
            //FileInputStream fileInput = new FileInputStream("Demo1/src/assets/textures/HighScore50Pix.gif"); //FOR LAPTOP
            //FileInputStream fileInput = new FileInputStream("resources/HighScore50Pix.gif"); // For JAR
